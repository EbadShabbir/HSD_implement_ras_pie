...
def smart_routing(prompt, target="qwen2.5:7b", draft="qwen2.5:0.5b"):
    print(f"\n{'='*70}")
    print(f"🧠 SMART ROUTING WITH SAFETY LAYER")
    print(f"{'='*70}\n")
    ...
    # Step 1: Try draft model
    print(f"{Fore.CYAN}⚡ Trying DRAFT model ({draft})...{Style.RESET_ALL}")
    ...
    if is_good:
        ...
        print(f"{Fore.GREEN}🎯 Routing to TARGET model ({target})...{Style.RESET_ALL}\n")
...
if __name__ == "__main__":
    print(f"\n{Fore.MAGENTA}{'='*70}")
    print("AI ASSISTANT WITH MENTAL HEALTH SAFETY LAYER")
